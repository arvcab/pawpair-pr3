...
app.config['MYSQL_HOST'] = 'aws-db.cwmy1ggqvdlh.us-east-2.rds.amazonaws.com'
app.config['MYSQL_USER'] = 'admin'
app.config['MYSQL_PASSWORD'] = 'Admin123'
app.config['MYSQL_DATABASE'] = 'awsdb'

# Configure security key with random string
app.config['SECRET_KEY'] = '!Q@W#E$R%T^Y&U*I(O)P'

# # Configure the database connection (GCloud)
# app.config['MYSQL_HOST'] = '34.82.50.202'
